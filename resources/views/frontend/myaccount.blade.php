                ...
                <div class="col-sm-12 col-md-9 col-lg-9">
                    ...
                    <div class="tab-content dashboard_content" data-aos="fade-up" data-aos-delay="200">
                                ...
                                <table>
                                    ...
                                    @foreach($my_orders as $key=>$my_order)
                                        <tr>
                                            ...
                                            <td><span class="success">{{ ($my_order->payment_status == 1?'Complated':'Processing') }}</span></td>
                                            <td>{{ number_format($my_order->grand_total, 2) }} </td>
                                            <td><a href="{{ route('Invoice.Download', $my_order->id) }}" class="view">download invoice</a></td>
                                        </tr>
                                    @endforeach
                                    </tbody>
                                </table>
                        ...
                        <div class="tab-pane" id="address">
                            ...
                            <p class="mb-2"><strong>{{ $user_info->name }}</strong></p>
                            <address>
