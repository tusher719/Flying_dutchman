<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown">
            ...
            <a class="nav-link" data-toggle="dropdown" href="#">
                <div class="image">
                    <img src="{{ asset('uploads/users') }}/{{ Auth::user()->user_photo }}" class="img-circle img-size-28 elevation-2"
                         alt="User Image">
            ...
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                <a href="#" class="dropdown-item dropdown-header mt-1 user-block">
                    <img src="{{ asset('uploads/users') }}/{{ Auth::user()->user_photo }}" class="img-circle img-size-40 elevation-2"
                         alt="User Image">
