        ...
        <div class="card-body">
            ...
            <div class="table-responsive-sm">
                <table class="table table-striped">
                    ...
                    <tbody>
                    @foreach(\App\Models\OrderProductDetails::where('order_id', $order_id)->get() as $key=>$order_info)
                        <tr>
                ...
                <div class="col-lg-5 col-sm-6 ml-auto">
                    <table class="table table-clear">
                        ...
                        <tr>
                            ...
                            <td class="right" style="background:#ffe4c4;">{{ number_format($data->first()->sub_total, 2) }}</td>
                        </tr>
                        <tr>
                            <td class="left">
                                <strong class="text-dark">Discount ({{ $data->first()->discount }}%)</strong>
                            </td>
                            <td class="right">{{ number_format($data->first()->sub_total-(($data->first()->sub_total*$data->first()->discount)/100),2) }}</td>
                        </tr>
                        <tr>
                            <td class="left">
                                <strong class="text-dark">Delivery Charge</strong>
                            </td>
                            <td class="right">{{ number_format($data->first()->delivery_charge, 2) }}</td>
                        </tr>
                        <tr>
                            <td class="left">
                                <strong class="text-dark">Total Paid</strong> </td>
                            <td class="right"  style="background:#7fffd4;">
                                <strong class="text-dark">{{ number_format($data->first()->grand_total,2) }}</strong>
                            </td>
                        </tr>
                        <tr>
                            <td class="left">
                            ...
                            <td class="right">{{ number_format(($data->first()->sub_total*$data->first()->discount)/100, 2) }}</td>
                        </tr>
                        </tbody>
                    </table>
                </div>
